...
const Courses = () => {
  ...
  return (
    <section className="courses section" id="courses">
        <h2 style={{marginTop:50}} className="section_title courses" id='course-title'>Featured Courses</h2>
        ...
        <div className="courses_container container grid">
                ...
                <div className="courses_modal-content">
                    ...
                    <ul className="courses_modal-courses grid">
                        ...
                        <li className="courses_modal-service">
                            ...
                            Build modern and dynamic user interfaces 
                            that are fast and responsive, making your web 
                            applications more engaging and user-friendly.</p>
                        </li>
                        ...
                        <li className="courses_modal-service">
                            ...
                            as React's component-based architecture makes it 
                            easier to break down complex UIs into manageable, 
                            reusable pieces of code.</p>
                        </li>
                        ...
                        <li className="courses_modal-service">
                            ...
                            employability by adding React JS to your skillset, 
                            as many companies are adopting this technology to 
                ...
                <div className="courses_modal-content">
                    ...
                    <ul className="courses_modal-courses grid">
                        ...
                        <li className="courses_modal-service">
                            ...
                            courses_modal-icon"></i>
                            <p className="courses_modal-info">
                            Create interactive and dynamic websites and web 
                            applications that can respond to user actions in real-time, 
                        ...
                        <li className="courses_modal-service">
                            ...
                            courses_modal-icon"></i>
                            <p className="courses_modal-info">
                            Develop server-side applications and command-line 
                            tools using Node.js, a popular JavaScript runtime 
                            built on Chrome's V8 engine.</p>
                        </li>
            ...
            <span onClick={() =>
            toggleTab(3)} className="courses_button">
            Go to course <i 
            className="uil uil-arrow-right 
            courses_button-icon"></i></span>
                ...
                <div className="courses_modal-content">
                    ...
                    <ul className="courses_modal-courses grid">
                        ...
                        <li className="courses_modal-service">
                            ...
                            courses_modal-icon"></i>
                            <p className="courses_modal-info">
                            Build and design visually appealing and responsive 
                            websites that can adapt to various devices and 
                            screen sizes.</p>
                        </li>
                        ...
                        <li className="courses_modal-service">
                            ...
                            courses_modal-icon"></i>
                            <p className="courses_modal-info">
                            Learn the foundational languages of the web and 
                            gain a better understanding of how web pages are 
                            structured and styled.</p>
                        </li>
                        ...
                        <li className="courses_modal-service">
                            ...
                            courses_modal-icon"></i>
                            <p className="courses_modal-info">
                            Increase your employability, as knowledge of HTML/CSS 
                            is essential for most front-end web development jobs 
                            and can also be useful for jobs in marketing, design, 
